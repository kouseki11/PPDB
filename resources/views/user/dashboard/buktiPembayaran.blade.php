          ...
          <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-0">
              <div class="w-100 bg-white ">
                <img src="{{ asset('images/payment_images/'. $payment['payment_image']) }}" alt="" srcset="" width="500" height="500" class="d-block m-auto pt-5">
                <p class="text-center mt-3 text-dark">Nama Bank : {{ $payment->bank }}</p>
                <p class="text-center mt-3 text-dark">Nama Pemilik Rekening : {{ $payment->name }}</p>
                <p class="text-center mt-3 text-dark">Nominal : {{ $payment->nominal }}</p>
                <div class="d-flex justify-content-center mt-2">
                <a href="{{ route('dashboard.payment') }}" class="btn btn-warning">Kembali</a>
                </div>
            </div> 
            </div>
          </div>
